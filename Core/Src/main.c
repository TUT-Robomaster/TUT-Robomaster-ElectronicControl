...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, INT_5833_Pin|Set_Reset_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, IMU_INT_Pin|OLED_DC_Pin|OLED_RST_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, AD8_Pin|AD7_Pin|AD6_Pin|AD5_Pin
                          |AD4_Pin|AD3_Pin|AD2_Pin|AD1_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : INT_5833_Pin Set_Reset_Pin LED_R_Pin */
  GPIO_InitStruct.Pin = INT_5833_Pin|Set_Reset_Pin|LED_R_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : IMU_INT_Pin OLED_DC_Pin OLED_RST_Pin */
  GPIO_InitStruct.Pin = IMU_INT_Pin|OLED_DC_Pin|OLED_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : LASER_Pin AD8_Pin AD7_Pin AD6_Pin
                           AD5_Pin AD4_Pin AD3_Pin AD2_Pin
                           AD1_Pin */
  GPIO_InitStruct.Pin = LASER_Pin|AD8_Pin|AD7_Pin|AD6_Pin
                          |AD5_Pin|AD4_Pin|AD3_Pin|AD2_Pin
                          |AD1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
